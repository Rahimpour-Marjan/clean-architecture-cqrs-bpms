...
namespace Application.ProductCategoryApplication.Queries.FilterData
{
    public class ProductCategoryParent
    {
        ...
        public class Handler : IRequestHandler<Query, FilterResponse>
        {
            ...
            {
                return await _uow.ProductCategoryRepository.FilterAllProductCategoryParent(request.Start, request.Length);
            }
        }
    }
}
