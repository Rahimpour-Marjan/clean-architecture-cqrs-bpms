...
namespace Application.CreditPaymentApplication.Queries.FilterData
{
    public class AccountCredit
    {
        ...
        public class Handler : IRequestHandler<Query, FilterResponse>
        {
            ...
            {
                return await _uow.CreditPaymentRepository.FilterAllAccountCredit(request.Start, request.Length);
            }
        }
    }
}
