...
namespace Application.AccountCreditApplication.Queries.FilterData
{
    public class AccountCheck
    {
        ...
        public class Handler : IRequestHandler<Query, FilterResponse>
        {
            ...
            {
                return await _uow.AccountCreditRepository.FilterAllAccountCheck(request.Start, request.Length);
            }
        }
    }
}
