...
namespace Application.ProductBrandApplication.Queries.FilterData
{
    public class ProductType
    {
        ...
        public class Handler : IRequestHandler<Query, FilterResponse>
        {
            ...
            {
                return await _uow.ProductBrandRepository.FilterAllProductType(request.Start, request.Length);
            }
        }
    }
}
