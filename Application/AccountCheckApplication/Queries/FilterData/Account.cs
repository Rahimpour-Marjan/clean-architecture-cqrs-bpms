...
namespace Application.AccountCheckApplication.Queries.FilterData
{
    public class Account
    {
        ...
        public class Handler : IRequestHandler<Query, FilterResponse>
        {
            ...
            {
                return await _uow.AccountCheckRepository.FilterAllAccount(request.Start, request.Length);
            }
        }
    }
}
