...
namespace Application.AccountApplication.Queries.FilterData
{
    public class EducationSubField
    {
        ...
        public class Handler : IRequestHandler<Query, FilterResponse>
        {
            ...
            {
                return await _uow.AccountRepository.FilterAllEducationSubField(request.Start, request.Length);
            }
        }
    }
}
